...
export function getProvider(id: string): LLMProvider | undefined {
  if (__test_override_provider !== undefined) return __test_override_provider;
  const row = db
    .select()
...
let __test_override_defaultProviderId: string | undefined;
let __test_override_provider: LLMProvider | undefined;
let __test_override_entryConfig: EntryConfig | undefined;

export function __setTestDefaultProviderId(id: string): void {
  __test_override_defaultProviderId = id;
}
export function __setTestProvider(p: LLMProvider | undefined): void {
  __test_override_provider = p;
}
export function __setTestEntryConfig(c: EntryConfig): void {
  __test_override_entryConfig = c;
}
export function __resetTestProviders(): void {
  __test_override_defaultProviderId = undefined;
  __test_override_provider = undefined;
  __test_override_entryConfig = undefined;
  globalThis.__agent_world_llm_clients__ = undefined;
}

/** Returns the active provider's ID, or throws if none set. */
export function getDefaultProviderId(): string {
  if (__test_override_defaultProviderId !== undefined) return __test_override_defaultProviderId;
  const row = db
