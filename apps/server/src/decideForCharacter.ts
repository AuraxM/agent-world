...
import { loadAllCharacters, loadManifest } from "@agw/config";
import { actionRegistry, actionTypeFromToolName } from "@agw/domain";
import type { Action, Character, WorldEvent } from "@agw/domain";
import type { DecideInput } from "@agw/llm";
